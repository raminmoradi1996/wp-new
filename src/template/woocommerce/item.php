...
<div class="m-3">
    ...
    <div class="mt-3 d-flex">
        <div class="m-1 d-flex justify-content-center align-items-center">
            <div class="num-style me-50">2</div>
            <div class="d-flex justify-content-center align-items-center m-1">
                <?php
                template::Label('', 'لطفا جنس مورد نظر را انتخاب کنید', 'text-dark');
                ?>
            </div>
        </div>
    ...
    <div class="d-flex align-items=center flex-wrap p-4" id="stz-cpw-item-cart-body-modal">
        ...
        ?>
            ...
            <div class="stz-cpw-item-cart-body mt-2 m-2 cursor-pointer" id="stz-cpw-item-cart-body-<?php echo $counter ?>">
                ...
                <div class="d-flex justify-conetnt-center align-items-center" style="position: relative;">
                    <img width="90%" style="height: 140px;" class="image-flouid mx-auto p-2 border-30" src="<?php echo wp_get_attachment_url($stz_value['image']) ?>" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-bag-check icon-select" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M10.854 8.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L7.5 10.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
                        <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z" />
                    </svg>
                </div>
                <div dir="rtl" class="d-flex flex-column align-items-center justify-content-center mb-3">
